...
public class DirectiveUtils {
    ...
    static com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper getOverrideBody(Environment env, String name) throws TemplateModelException {
        com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper value = (com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper)env.getVariable(DirectiveUtils.getOverrideVariableName(name));
        return value;
    }

    static void setTopBodyForParentBody(Environment env,
                                        com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper topBody,
                                        com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper overrideBody) {
        com.wanliang.micro.web.directive.OverrideDirective.TemplateDirectiveBodyOverrideWraper parent = overrideBody;
