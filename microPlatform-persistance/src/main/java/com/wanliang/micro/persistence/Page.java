...
public class Page<T> {
    ...
    public String toString() {
        ...
        sb.append("<input type=\"text\" style=\"width:50px;margin:0;padding:0;text-align:center;\" value=\"" + pageNo + "\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
        sb.append(funcName + "(this.value," + pageSize + ",'" + funcParam + "');\" onclick=\"this.select();\"/> / ");
        sb.append("<input type=\"text\" style=\"width:50px;margin:0;padding:0;text-align:center;\" value=\"" + pageSize + "\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
        sb.append(funcName + "(" + pageNo + ",this.value,'" + funcParam + "');\" onclick=\"this.select();\"/> 条，");
        sb.append("共 " + count + " 条" + (message != null ? message : "") + "</a></li>\n");

        sb.insert(0, "<ul class=\"pager\">\n").append("</ul>\n");
